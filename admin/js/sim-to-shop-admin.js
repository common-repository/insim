...
window.addEventListener('DOMContentLoaded', () => {
    jQuery('span.disabled').on('click', function(event) {
        event.preventDefault();
      });
    if (undefined != document.getElementById('contact_form') && null != document.getElementById('contact_form')) {
        document.getElementById('contact_form').addEventListener('submit', function (e) {
            e.preventDefault();

                            var mail= jQuery('#email_input').val();
                            var phone = jQuery('#telephone_input').val();
							var name = jQuery('#name_input').val();
							var subject = jQuery('#subject_input').val();
                            var details = jQuery('#message_input').val();

		                    var request = jQuery.ajax({
                            
                            url: "https://www.ardary-sms.com/api/wooc_contact_us.php",
                            type: "POST",
                            data: {
                                name: name,
                                mail: mail,
            ...
            document.getElementById('submit_success').style.display = 'inline-block';
        });
    }

    if (undefined != document.getElementsByName('sendsms_message') && null != document.getElementsByName('sendsms_message') && document.getElementsByName('sendsms_message').length >0) {
        document.getElementsByName('sendsms_message')[0].addEventListener('input', function (e) {
            document.getElementById('messageRess').value = document.getElementsByName('sendsms_message')[0].value;
        });
    }
    

    if(undefined != document.getElementById('sendsms_title') && null != document.getElementById('sendsms_title') ){
        document.getElementById('sendsms_title').addEventListener('input', function (e) {
            document.getElementById('titleRes').value = document.getElementById('sendsms_title').value;
        });
    }
    if(undefined != document.getElementById('sendsms_date') && null != document.getElementById('sendsms_date')){
        document.getElementById('sendsms_date').addEventListener('input', function (e) {
            document.getElementById('dateRes').value = document.getElementById('sendsms_date').value+' '+document.getElementById('sendsms_date_hour').value+':'+document.getElementById('sendsms_date_minute').value;
        });
    }
    if(undefined != document.getElementById('sendsms_date_hour') && null != document.getElementById('sendsms_date_hour')){
        document.getElementById('sendsms_date_hour').addEventListener('input', function (e) {
            document.getElementById('dateRes').value = document.getElementById('sendsms_date').value+' '+document.getElementById('sendsms_date_hour').value+':'+document.getElementById('sendsms_date_minute').value;
        });
    }
    if(undefined != document.getElementById('sendsms_date_minute') && null != document.getElementById('sendsms_date_minute')){
        document.getElementById('sendsms_date_minute').addEventListener('input', function (e) {
            document.getElementById('dateRes').value = document.getElementById('sendsms_date').value+' '+document.getElementById('sendsms_date_hour').value+':'+document.getElementById('sendsms_date_minute').value+':00';
        });
    }
    if(undefined != document.getElementsByClassName('wp-list-table widefat fixed striped table-view-list recipients') && null != document.getElementsByClassName('wp-list-table widefat fixed striped table-view-list recipients')
    && document.getElementsByName('wp-list-table widefat fixed striped table-view-list recipients').length >0){
        if (document.getElementsByClassName('wp-list-table widefat fixed striped table-view-list recipients')[0].rows.length > 3){
            jQuery('#sendsms_query_add').attr('disabled', 'disabled');
        }
    }

    if (undefined != document.getElementsByName('sendsms_query_country') && null != document.getElementsByName('sendsms_query_country') && document.getElementsByName('sendsms_query_country').length >0) {
        document.getElementById('sendsms_query_country').addEventListener('input', function (e) {
            jQuery('#sendsms_query_add').removeAttr('disabled');
            jQuery('#customers_selected').css('display', 'block');
        });
    }

    if (undefined != document.getElementsByName('sendsms_query_registered_from') && null != document.getElementsByName('sendsms_query_registered_from') && document.getElementsByName('sendsms_query_registered_from').length >0) {
        document.getElementsByName('sendsms_query_registered_from')[0].addEventListener('input', function (e) {
            console.log('111');
            jQuery('#customers_selected').css('display', 'block');
            jQuery('#sendsms_query_add').removeAttr('disabled');
    ...
    if (undefined != document.getElementsByName('sendsms_query_registered_to') && null != document.getElementsByName('sendsms_query_registered_to') && document.getElementsByName('sendsms_query_registered_to').length >0) {
        document.getElementsByName('sendsms_query_registered_to')[0].addEventListener('input', function (e) {
            jQuery('#sendsms_query_add').removeAttr('disabled');
            jQuery('#customers_selected').css('display', 'block');
    ...
    if (undefined != document.getElementsByName('sendsms_query_connected_from') && null != document.getElementsByName('sendsms_query_connected_from') && document.getElementsByName('sendsms_query_connected_from').length >0) {
        document.getElementsByName('sendsms_query_connected_from')[0].addEventListener('input', function (e) {
            jQuery('#customers_selected').css('display', 'block');
            jQuery('#sendsms_query_add').removeAttr('disabled');
            
        });
    }
    if (undefined != document.getElementsByName('sendsms_query_connected_to') && null != document.getElementsByName('sendsms_query_connected_to') && document.getElementsByName('sendsms_query_connected_to').length >0) {
        document.getElementsByName('sendsms_query_connected_to')[0].addEventListener('input', function (e) {
            jQuery('#customers_selected').css('display', 'block');
            jQuery('#sendsms_query_add').removeAttr('disabled');
            
        });
    }
    if (undefined != document.getElementsByName('sendsms_query_orders_from') && null != document.getElementsByName('sendsms_query_orders_from') && document.getElementsByName('sendsms_query_orders_from').length >0) {
        document.getElementsByName('sendsms_query_orders_from')[0].addEventListener('input', function (e) {
            jQuery('#customers_selected').css('display', 'block');
            jQuery('#sendsms_query_add').removeAttr('disabled');
            
        });
    }
    if (undefined != document.getElementsByName('sendsms_query_orders_to') && null != document.getElementsByName('sendsms_query_orders_to') && document.getElementsByName('sendsms_query_orders_to').length >0) {
        document.getElementsByName('sendsms_query_orders_to')[0].addEventListener('input', function (e) {
            jQuery('#sendsms_query_add').removeAttr('disabled');
            jQuery('#customers_selected').css('display', 'block');
        });
    }
    ...
    //     if ( scrollPercent >40 ) {
    //         jQuery('#next_step2').css('display', 'block');
    //         jQuery('#customers_selected').css('display', 'none');
    //     }
    //     else {
    //         jQuery('#customers_selected').css('display', 'block');
    //         jQuery('#next_step2').css('display', 'none');
    //         }
    // });
});
    ...
    jQuery(function () {
        ...
        if (jQuery('#sendsms_form').length > 0) {
            ...
            jQuery('#sendsms_query_add').click(function (e) {
                jQuery('#sendsms_query_add').attr('disabled', 'disabled');
                //document.getElementById('sendsms_recipient').scrollIntoView();
                jQuery(document).ready(function(){
                    jQuery('html, body').animate({
                        scrollTop: jQuery("#sendsms_recipient").offset().top
                    }, 1000);
                });
                jQuery('#load_recipients_list').css('display', 'inline-block');
                jQuery('#load_recipients_list_text').css('display', 'inline-block');
                setTimeout( () => {addRecipientsFromQuery();}, 500);
            });
...
function initButtons(show) {
    ...
    document.getElementById('sendsms_save').addEventListener('click', () => {
    ...
    if (status >= 0 && jQuery('#nb_recipients').html() > 0) {
        jQuery('#sendsms_validate').show();
    } else {
        jQuery('#sendsms_validate').hide();
        jQuery('#sendsms_duplicate').hide();
        jQuery('#sendsms_other_options').hide();
    }
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    jQuery('#sendsms_query_result_to_add').html(data.total_rows);
                    if (data.total_rows > 0 && data.total_rows <= 3000){
                        jQuery('#sendsms_max').css('display', 'none');
                        ...
                        jQuery('#sendsms_query_add').attr('disabled', 'disabled');
                        jQuery('#sendsms_max').css('display', 'block');
                    }
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    list.update(data);
                    jQuery('#load_recipients_list').css('display', 'none');
                    jQuery('#load_recipients_list_text').css('display', 'none');
                    jQuery('#sendsms_query_add').attr('disabled', 'disabled');
