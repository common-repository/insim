...
class Sim_To_Shop_Activator {
    ...
    public static function activate() {
        //register_activation_hook(__FILE__, 'sim_to_shop_activation');
         ...
         */
        //function sim_to_shop_activation() {
        wp_schedule_event(time(), 'daily', 'sim_to_shop_event_daily_hook');
        //}
        self::_create_tables();
    }
    ...
    /**
     * Create tables for the sim-to-shop plugin.
     * 
     * @global type $wpdb
